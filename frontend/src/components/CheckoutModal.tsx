...
export const CheckoutModal: React.FC<CheckoutModalProps> = ({
  ...
  const handlePlaceOrder = () => {
    setIsOrdering(true);
    // Simulate API calls & database transaction delays
    setTimeout(() => {
      setIsOrdering(false);
        ...
        >
          ...
          <div className="p-6 border-b border-white/5 flex items-center justify-between">
            ...
            {!orderConfirmed && (
              <button
                onClick={onClose}
                className="p-1.5 hover:bg-white/5 text-white rounded-lg cursor-pointer"
              >
                <X className="w-4 h-4" />
              </button>
            )}
          ...
          <div className="p-6 min-h-[220px] flex flex-col justify-center">
            {orderConfirmed ? (
              ...
              <div className="text-center py-6 space-y-4">
                ...
                <div>
                  <h4 className="font-bold text-white text-lg">Order Placed Successfully!</h4>
                  <p className="text-xs text-textSecondary mt-1 leading-relaxed">
                    Your order has been transmitted. The vendor has begun packing.
                  </p>
                  <div className="mt-4 p-3 bg-white/5 rounded-xl border border-white/5 w-fit mx-auto text-xs font-bold font-mono text-primary">
              ...
              <div>
                  ...
                  >
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-3 py-2 bg-white/5 border border-white/5 rounded-xl text-xs text-white focus:outline-none focus:border-primary"
                      />
                    </div>
                    <div>
                      ...
                      <button
                        ...
                        className={`w-full p-4 rounded-2xl flex items-center justify-between border cursor-pointer transition-all ${
                          paymentMethod === method
                            ...
                            : 'bg-white/5 border-white/5 hover:border-white/10 text-textSecondary'
                        }`}
                      >
                ...
                {step === 3 && (
                  ...
                  >
                    ...
                    <div className="glass-panel p-4 rounded-2xl space-y-2.5 text-xs text-textSecondary">
                      <div className="flex justify-between">
                        <span>Ship To</span>
                        <span className="text-white font-semibold text-right">{address}, {apartment}</span>
                      </div>
                      <div className="flex justify-between">
                        <span>Method</span>
          ...
          {/* Footer Controls */}
          {!orderConfirmed && (
            <div className="p-6 border-t border-white/5 flex items-center justify-between gap-3 bg-[#080D1A]">
              {step > 1 ? (
                <button
                  onClick={prevStep}
                  className="px-4 py-2.5 bg-white/5 hover:bg-white/10 text-white rounded-xl text-xs font-semibold flex items-center gap-1.5 cursor-pointer"
                >
